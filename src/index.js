module.exports = function toReadable (number) {
  ...
  let tensNums = {20: "twenty", 30: "thirty", 40: "forty", 50: "fifty", 60: "sixty", 70: "seventy", 80: "eighty", 90: "ninety"};
  let result = "";
  ...
  if(number < 20) {
    ...
    return number % 10 === 0 ? result = tensNums[number] : result = `${tensNums[flooredTens]} ${nums[+unites]}`;
    ...
    if(number % 100 === 0) {
      ...
      return tens % 10 === 0 ? result = `${nums[+hundreds]} hundred ${tensNums[+tens]}` : result = `${nums[+hundreds]} hundred ${tensNums[+flooredTens]} ${nums[+unites]}`;
    }
  }
}